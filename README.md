...
Admin dashboard generated by AppSeed in **Django** Framework. A high-quality & free Bootstrap admin dashboard template pack that comes with lots of templates and components. Based on Bootstrap 4, **[Shards Dashboard Lite](https://appseed.us/admin-dashboards/django-dashboard-shards)** is fully responsive and capable to adapt its layout to any viewport size - Design provided by DesignRevision.
